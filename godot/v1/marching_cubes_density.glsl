...
void main()
{
    ...
    vec4 corners[8] = {
        sample_position(vec3(id.x + 0, id.y + 0, id.z + 0)),
        sample_position(vec3(id.x + 1, id.y + 0, id.z + 0)),
        sample_position(vec3(id.x + 1, id.y + 0, id.z + 1)),
        sample_position(vec3(id.x + 0, id.y + 0, id.z + 1)),
        sample_position(vec3(id.x + 0, id.y + 1, id.z + 0)),
        sample_position(vec3(id.x + 1, id.y + 1, id.z + 0)),
        sample_position(vec3(id.x + 1, id.y + 1, id.z + 1)),
        sample_position(vec3(id.x + 0, id.y + 1, id.z + 1))
    };
